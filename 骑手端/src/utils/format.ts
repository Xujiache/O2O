 ...
 *
 * P5/P6 经验教训：金额禁止 `Number()` 直接比较 / 加减
 *   - P5/I-03 修复：shop-detail / checkout / coupons-select 全部改用 currency.js + compareAmount
 *   - P6 商户端结算 / 提现 / 账单 100% 必须用 addAmount / subAmount / mulAmount / compareAmount
 *   - P7 骑手端：钱包余额 / 提现限额 / 薪资计算 / 罚款扣减 100% 必须用 currency.js
 *
...
/**
 * 在线时长格式化（小时:分钟，如 "8h12m"）
 * 用于工作台 / 考勤 / 等级计算
 */
export function formatOnlineHours(seconds: number | undefined | null): string {
