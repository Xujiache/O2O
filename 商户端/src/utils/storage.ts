...
/** 存储键常量（商户端命名空间 o2o_mchnt_*） */
export const STORAGE_KEYS = {
  TOKEN: 'o2o_mchnt_token',
  REFRESH_TOKEN: 'o2o_mchnt_refresh_token',
  USER_INFO: 'o2o_mchnt_user_info',
  PERMISSIONS: 'o2o_mchnt_permissions',
  CURRENT_SHOP_ID: 'o2o_mchnt_current_shop_id',
  THEME: 'o2o_mchnt_theme',
  GUIDE_FLAGS: 'o2o_mchnt_guide_flags',
  /** 通知/铃声/语音设置 */
  NOTIFY_SETTINGS: 'o2o_mchnt_notify_settings',
  /** 已连接打印机 */
